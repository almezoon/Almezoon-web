            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  >
                    {showDetails === product.id ? "Hide Details" : "View Details"}
                  </button>
                </div>
